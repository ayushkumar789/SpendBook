  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.pageBg }}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.typeRow}>
          <TouchableOpacity
            ...
            onPress={() => { setTxnType('in'); setCategory(''); }}
            activeOpacity={0.8}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => { setTxnType('out'); setCategory(''); }}
            activeOpacity={0.8}
          >
      ...
      <BottomSheet
        ...
        onClose={() => setPmSheetVisible(false)}
        title="Select Payment Method"
      >
        <TouchableOpacity
          style={styles.pmRow}
          onPress={() => { setPaymentMethodId(null); setPmSheetVisible(false); }}
        >
        ...
        {methods.map((m) => (
          <TouchableOpacity
            key={m.id}
            style={styles.pmRow}
            onPress={() => { setPaymentMethodId(m.id); setPmSheetVisible(false); }}
          >
